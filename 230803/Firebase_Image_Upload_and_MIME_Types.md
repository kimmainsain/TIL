...
| 타입         | 설명                                                                                                       | 일반적인 서브타입 예시                                                                                                             |
|--------------|------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| `text`       | 텍스트를 포함하는 모든 문서를 나타내며 이론상으로는 인간이 읽을 수 있어야 합니다                             | `text/plain`, `text/html`, `text/css`, `text/javascript` (`application/javascript` 권장)                                           |
| `image`      | 모든 종류의 이미지를 나타냅니다. 애니메이션되는 이미지(예: animated gif)는 포함되나, 비디오는 포함되지 않습니다 | `image/gif`, `image/png`, `image/jpeg`, `image/bmp`, `image/webp`                                                                   |
...
HTTP 본문에는 **이진 형식으로 인코딩된 이미지 데이터가 포함될 것**이다. 이를 통해 클라이언트나 서버가 본문의 데이터를 올바르게 해석하고 처리할 수 있게 된다.
