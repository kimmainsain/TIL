...
- **[230802: konva의 이미지를 Firebase에 저장](https://github.com/kimmainsain/TIL/blob/master/230802/Konva_Images_in_Firebase.md)**  
  프로젝트에서 별자리 커스텀 이미지를 konva로 생성한 후, 그 결과물을 Firebase에 어떻게 저장할지 고민하고 어떻게 코드를 작성해야하는지 방향을 정리했습니다.
